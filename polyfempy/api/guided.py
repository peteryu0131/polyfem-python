...
# Keep the recommended star-import surface focused on user intent factories.
# Type aliases, dataclasses, and legacy names remain available as explicit
# attributes such as ``g.BodySection`` or ``g.experiment_template``.
GUIDED_CORE_API = [
    "adhesion_section",
    "bodies_section",
    "body_section",
